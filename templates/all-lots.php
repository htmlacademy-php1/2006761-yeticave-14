    ...
    <nav class="nav">
        <ul class="nav__list container">
            <?php foreach ($sqlCategories as $value) :?>
                <li class='nav__item <?=htmlspecialchars($value['symbol_code']) ===
                                        htmlspecialchars($_GET['categoryName']) ? 'nav__item--current' : '' ?>'>
        ...
        <ul class="pagination-list">
            <li class="pagination-item pagination-item-prev">
                <a href="<?='all-lots.php?categoryName=' .
                             htmlspecialchars($categoryName) . '&page=' . $pagination['prevPage']?>">Назад</a>
            </li>
            <?php foreach ($pagination['pages'] as $value) :?>
                ...
                <li class="pagination-item">
                    <a href="<?='all-lots.php?categoryName=' .
                                 htmlspecialchars($categoryName) . '&page=' . $value?>"><?=$value?></a>
                </li>
                <?php endif;?>
            <?php endforeach;?>
            <li class="pagination-item pagination-item-next">
                <a href="<?='all-lots.php?categoryName=' .
                             htmlspecialchars($categoryName) . '&page=' . $pagination['nextPage']?>">Вперед</a>
            </li>
        </ul>
        <?php endif;?>
    </div>
